...
import (
	...
	"github.com/VineshNeoshore/pdfcpu/internal/corefont/metrics"
...
func (fd TTFLight) unicodeRangeBits(id string) []int {
	...
	// Please go to https://github.com/VineshNeoshore/pdfcpu/issues/new/choose for an extension request.
	//
